...
<div class="note">
  ...
  <p>About <strong>60 mA per rail</strong> typical, against the 130 mA the 500-series
  specification allows. Worst-case NE5532s with a hard-driven output land near 110 mA. Building
  a stereo pair into a small frame? Omitting the aux section gives back roughly 16 mA per rail
  per module.</p>
</div>
""")
